...
[English](../en/data-and-tasks.md) · [首页](../../README.zh-CN.md) · [示例](examples.md)
...
在 AI 对话中说明数据源、品种范围、周期、复权、数据窗口、计算方法和输出。已有 `.tft` 时，把完整文本提供给助手；不要假定业务 MCP 可以直接读取应用仓库里的文件。可参考[随仓库的示例](../../examples/user-research/README.zh-CN.md)。
