...
[English](../en/api-reference.md) · [首页](../../README.zh-CN.md) · [连接指南](ai-guide.md)
...
源码合同：[公共工具](../../src/ai-capabilities/contracts.ts)、[指标指南](../../src/user-indicator-runtime/ai-guide.ts)、[连接器指南](../../src/user-data/guide.ts)、[任务指南](../../src/user-task/guide.ts)。用户另行授权的源码开发见[源码扩展](extensions.md)。
