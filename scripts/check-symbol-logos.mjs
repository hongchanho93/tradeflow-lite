...
import { exchangeDisplayName, exchangeLogoUrl, symbolLogoUrls } from '../src/symbol-logos.ts';
...
if (exchangeDisplayName('BINANCE_USDM') !== 'BINANCE') throw new Error('Binance perpetual rows must use the concise exchange name');
if (exchangeDisplayName('OKX_SWAP') !== 'OKX') throw new Error('OKX swap rows must use the concise exchange name');
if (exchangeDisplayName('SH') !== 'SH') throw new Error('stock exchange names must remain unchanged');
